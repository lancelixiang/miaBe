...
class PatchFeatureExtractor:
    ...
    def __init__(self, architecture: str, device: torch.device) -> None:
        ...
        if architecture.startswith("s3://mlflow"):
        ...
        elif architecture.startswith("MambaVision"):
            ...
            model = AutoModelForImageClassification.from_pretrained(f"nvidia/{architecture}", trust_remote_code=True).to(self.device)
        elif architecture.endswith(".pth"):
